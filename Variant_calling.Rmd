...
The tsv of the removed sites are very similar to the tsv of the original combined vcf, which suggests that the quality is poor.
...
-Ou /mnt/atgc-d1/bioinfoII/sgamino/variant_calling/data/merged.bam | \
...
[sgamino@compute-00-04 data]$ bcftools view -r chrI -i 'GT!="./."' -O b -o multi_chrI.bcf multi.bcf # Here, i filtered my multi.bcf for just the variants in chrI. -r restricted the filter for just the chrI, and then -i 'GT!=./.' filters for samples in which the genotype was empty.
